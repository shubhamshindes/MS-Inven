...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, ReorderEvent> reorderConsumerFactory() {
        ...
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "com.inven.common.dto");
        props.put(JsonDeserializer.TYPE_MAPPINGS, "reorderEvent:com.inven.common.dto.ReorderEvent");
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, ReorderEvent> kafkaListenerContainerFactory() {
